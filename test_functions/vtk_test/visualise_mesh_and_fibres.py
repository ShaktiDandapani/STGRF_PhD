...
def write_fibres_vtk(filename, centroids_dictionary, fibres_dictionary):
    ...
    with open(filename, 'w') as fib_file:
        ...
        for e_no, centroid in centroids_dictionary.items():
            ...
            avec_x = centroid_x + avec[0] #* 2
            avec_y = centroid_y + avec[1] #* 2
            avec_z = centroid_z + avec[2] #* 2

            # Calculate bvector based on avector not on the centroid
            bvec_x = centroid_x + bvec[0] #* 2
            bvec_y = centroid_y + bvec[1] #* 2
            bvec_z = centroid_z + bvec[2] #* 2
            ...
            # fib_file.write("{} {} {}\n".format(0.0, 0.0, 0.0)) # just unit vecs around origin 
...
def create_mesh():
    ...
    fibres = read_fibres("materials.dat")
